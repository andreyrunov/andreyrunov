# Всем привет!👋 Меня зовут Андрей. Работаю Frontend разработчиком, разрабатываю SAAS сервис в сфере лесозаготовки.

Занимаюсь разработкой более 3-х лет. Пишу на JS, TS, React + Redux (Redux Toolkit, Zustand), Node.JS. 
Большой опыт работы с фреймворком Next.js. Есть опыт с Jest юнит-тестированием. 
В данный момент более углубленно изучаю TypeScript.
