# Всем привет!👋 Меня зовут Андрей. Работаю Frontend-программистом.

Занимаюсь разработкой более 4-х лет. Пишу на JS, TS, React + Redux (Redux Toolkit, Zustand), Node.JS. 
